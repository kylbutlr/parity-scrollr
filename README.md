...
4. Pin Parity Scrollr to the toolbar.
...
See the full [permission audit](docs/permissions.md), [privacy policy draft](docs/privacy.md), and [troubleshooting guide](docs/troubleshooting.md).
...
- [Support policy draft](docs/support.md)
...
The public privacy-policy URL, approved support destination, and store publication remain separate release decisions.
